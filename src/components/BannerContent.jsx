...
const BannerContent = ({h2_text,h1_text,population,territory,avgPrice}) => {
  ...
  return (
    ...
    <Container>
    <div className='flex flex-col xl:flex-row xl:items-center bg-white rounded-lg md:rounded-[60px] px-[28px] sm:px-[40px] xl:px-[70px] py-3 sm:py-8 xl:py-5 gap-y-3 sm:gap-y-10  gap-x-28'>
      ...
      <div className='flex sm:flex-row flex-col items-start sm:items-center gap-y-4 gap-x-[40px] sm:gap-x-[190px] md:gap-x-[214px] xl:gap-x-44'>
        <div className='flex items-center gap-x-5'>
          <div className='md:w-[60px] md:h-[60px] w-[35px] h-[35px] rounded-full border-main border-2 flex items-center justify-center'>
